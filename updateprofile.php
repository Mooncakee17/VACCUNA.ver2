...
if(isset($_POST['update_profile'])){   
   ...
   mysqli_query($conn, "UPDATE `usertable` SET firstname = '$update_firstname', lastname = '$update_lastname', username = '$update_username', user_email = '$update_email' WHERE userid = '$user_id'") or die('query failed');
...
<div class="update-profile">    <!-- style sa css  -->
